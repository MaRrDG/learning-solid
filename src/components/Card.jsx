const Card = ({ title, description }) => {
  return (
    <div className="w-[16rem] h-[22rem] bg-gray-600 rounded-lg flex flex-col justify-center items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
      ...
      <button
        type="button"
        className="h-12 mt-auto mb-6 w-32 text-center rounded-md border border-transparent bg-indigo-500  text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
        PLAY
      </button>
    </div>
